...
== Changelog ==
= = 1.4.5 (2016-27-07) =
* Security release fix unsecure adminer editor loading

= 1.4.4 (2016-03-04) =
* Enhancements in css, design
* Include Adminer Core 4.2.4, follow changes
* Fix remote execution in SQLite query
* MySQL: Support PHP 7
* Bosnian translation in Adminer core, not WP backe-end page
* Finnish translation in Adminer core, not WP backe-end page
* Fix XSS in indexes (non-MySQL only)
* Support PHP 7
* Greek translation in Adminer core, not WP backe-end page
* Galician translation in Adminer core, not WP backe-end page
* Bulgarian translation in Adminer core, not WP backe-end page
